...
static int _map_find_hash(Map *map, const char *key, u32 len, u32 h)
{
	u32 i;
...
int _map_find(Map *map, const char *key, u32 len)
{
	u32 h;
	h = _map_hash(key, len);
...
int _map_insert(Map *map, const char *key, u32 len)
{
	u32 h;
